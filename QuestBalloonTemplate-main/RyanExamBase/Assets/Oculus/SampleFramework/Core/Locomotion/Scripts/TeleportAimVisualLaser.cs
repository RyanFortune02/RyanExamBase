...
public class TeleportAimVisualLaser : TeleportSupport
{
	...
	void Awake()
	{
		...
		_lineRenderer = Instantiate(LaserPrefab);  //I cannot figure out where I need to increase size using 
	}
	...
	{
		_lineRenderer.sharedMaterial.color = obj.TargetValid ? Color.yellow : Color.blue;  //changed color  and changed width 
